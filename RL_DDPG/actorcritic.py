...
HID_LAYER1 = 40     # the number of neurons in hidden layer 1
HID_LAYER2 = 40     # the number of neurons in hidden layer 2
WFINAL = 0.003      # initalization parameters of third fully-connected layer
